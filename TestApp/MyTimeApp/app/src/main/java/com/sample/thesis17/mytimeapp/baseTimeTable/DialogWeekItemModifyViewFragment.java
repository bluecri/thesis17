...
public class DialogWeekItemModifyViewFragment extends DialogFragment{

    private Context curContext = null;
    private DialogWeekItemModifyViewFragmentListener dialogWeekItemModifyViewFragmentListener = null;
    ...
    public DialogWeekItemModifyViewFragment() {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        Log.d("DialogMarkerModifyFra", "DialogWeekItemModifyViewFragment onCreate");
        //markerTypeList = -Listener.getMarkerTypeModifiedDataList();
        try{
            dialogWeekItemModifyViewFragmentListener = (DialogWeekItemModifyViewFragmentListener) getTargetFragment();
        }
    ...
    public void onAttach(Context context) {
        ...
        Log.d("DialogWeekItemModi", "DialogWeekItemModifyViewFragment onattach");
        curContext = context;
    }
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        textViewTitle = (EditText)retView.findViewById(R.id.fragment_dialog_timetable_item_modify_title);
        spinnerStartWeek = (Spinner)retView.findViewById(R.id.fragment_dialog_timetable_item_modify_startweek);
        textViewStartTime = (Button)retView.findViewById(R.id.fragment_dialog_timetable_item_modify_starttime);
        spinnerEndWeek = (Spinner)retView.findViewById(R.id.fragment_dialog_timetable_item_modify_endweek);
        textViewEndTime = (Button)retView.findViewById(R.id.fragment_dialog_timetable_item_modify_endtime);
        ...
        */
        ...
        spinnerMarkerName.setSelection(listInnerSpinnerMarkerDataList.indexOf(listMarkerDataList.get(markerDataListIdx)));
        ...
        builder.setView(retView)
                ...
                .setPositiveButton("수정", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int id) {
                        ...
                        dialogWeekItemModifyViewFragmentListener.doModify(textViewTitle.getText().toString(), retLStartTimeMillis, retLEndTimeMillis, listMarkerDataList.indexOf(listInnerSpinnerMarkerDataList.get(innerSpinnerIdx)), textViewMemo.getText().toString());
                    }
                })
                .setNegativeButton("취소", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
                        DialogWeekItemModifyViewFragment.this.getDialog().cancel();  //cancel dialog
