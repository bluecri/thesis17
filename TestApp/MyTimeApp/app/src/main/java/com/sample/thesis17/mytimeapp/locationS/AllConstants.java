...
public class AllConstants {
    ...
    public static final int USEGPS_FLAG = 0x04;
    public static final int USEWIFI_FLAG = 0x02;
    public static final int USEDATA_FLAG = 0x01;
