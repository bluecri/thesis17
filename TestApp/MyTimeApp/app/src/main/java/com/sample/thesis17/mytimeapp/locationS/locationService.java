...
public class locationService extends Service {
    ...
    /*
    Thread threadLocationMemoryDataProcessWithGps = new Thread(){
        @Override
        public void run() {
            try{
                if(isUseGps){
                    ...
                    locationManager.removeUpdates(getLocationListenerCustomGps);    //if therer is no getLocationListenerCustomGps update, mListeners.remove return null.. Therefore, can be called with same param again.
                ...
                dataLMForGpsThread.setfAccur((float)0.0);   //init mark
                locationManager.removeUpdates(getLocationListenerCustomGps);
                //close DB
            }
